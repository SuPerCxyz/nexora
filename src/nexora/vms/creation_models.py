"""Persistent confirmation plans for importing a managed volume as a VM."""
...
class VmCreationPlan(Base):
    __tablename__ = "vm_creation_plans"
    ...
    volume_resource_id: Mapped[str] = mapped_column(String(36), nullable=False)
    volume_native_id: Mapped[str] = mapped_column(String(512), nullable=False)
    volume_generation: Mapped[int] = mapped_column(Integer, nullable=False)
    volume_hash: Mapped[str] = mapped_column(String(64), nullable=False)
