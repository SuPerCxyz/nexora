"""Persistent confirmation plans for blank-disk VM creation."""
...
class VmBlankCreationPlan(Base):
    __tablename__ = "vm_blank_creation_plans"
    ...
    volume_xml: Mapped[bytes] = mapped_column(LargeBinary, nullable=False)
